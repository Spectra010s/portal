...
- Impact: the update_field logic gets organized into "Sections" (user, network, storage).
...
- Goal: Receiver reads this path and saves files there instead of the current working directory or Reciver specifies the path they want to save.
...
- Goal: Security and Consent. we need the user.username from [Issue 3](https://github.com/Spectra010s/portal/issues/31) to be solid before we start sending it over the wire.

4. Progress Bars with indicatif [(Issue 18)](https://github.com/Spectra010s/portal/issues/18)
...
5. Logging System [(Issue 4)](https://github.com/Spectra010s/portal/issues/5)
...
6. Polling and Retry Logic [(Issue 26)](https://github.com/Spectra010s/portal/issues/26)
