...
description: Overview of the Portal Transfer Protocol (PXP) application layer design.
---
...
|---|---|---|
| 1. Discovery | UDP | [PXP-DISCOVERY](discovery) |
| 2. Handshake | TCP | [PXP-HANDSHAKE](handshake) |
| 3. Manifest | TCP | [PXP-MANIFEST](manifest) |
| 4. Streaming | TCP | [PXP-STREAMING](streaming) |
