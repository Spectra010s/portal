---
title: PXP-MANIFEST (Manifest Spec)
description: Specification for the variable-length global transfer manifest.
---
...
| `compressed` | bool | MUST | If `true`, the data stream in [PXP-STREAMING](streaming) is Gzip-compressed. If `false`, raw TAR. |
...
4. MUST proceed to [PXP-STREAMING](streaming) to begin receiving data.
